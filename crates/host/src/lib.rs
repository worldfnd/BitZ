//! Responsible for serializing and deserializing proofs that crosses the host boundary
//! as byte string.
//!
...
//!   field.
//! - **Bijection**. Each proof corresponds to exactly one byte string,
//!   and vice versa.
//!
...
/// Encoding round trip test suite.
#[cfg(test)]
mod tests {
