//! Backend-independent operations used to build a BitZ circuit.
//!
...
/// Arithmetic required of coefficients on the Z side of a BitZ circuit.
///
...
/// Operations needed to construct a BitZ circuit.
///
