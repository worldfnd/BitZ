...
\newenvironment{normative}
  {\par\smallskip\begingroup
   ...
   \color{specnavy}\noindent\textbf{Normative v1 profile.}\ }
...
\begin{normative}
This document discusses the general step by step process for the F2Z polynomial commitment scheme (PCS) as well as using the PIMSAT relation and reducing it to the F2Z PCS. We will first discuss the general definitions along with the relations used in the F2Z PCS along ways to directly reduction the relations to simpler claims. 
\end{normative}
