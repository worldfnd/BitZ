...
Tags \code{4002} and \code{4103} are enabled only by a top-level profile that
declares a general-coefficient LinCheck; the direct v1 profile requires zero
such events.  An enabled profile alternates, for $i=0,\ldots,m-1$, one
