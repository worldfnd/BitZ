...
preserve the MLE coefficient shape admitted by the current internal ring
switch.  A virtual profile must therefore supply a compatible
$\Pi_{\rm iopp}$ adapter or opening; the direct profile rejects the virtual
source.
